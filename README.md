...
sockets, no accounts; one small C99 binary. The mechanism is proven: it is
essentially Unix local mail - an append-only mbox the mailer `flock`-locks, read
forward - pointed at agents instead of people.
